    ...
    public class AuthorsController : ControllerBase
    {
            ...
            [FromQuery] AuthorsResourceParameters authorsResourceParameters)
        {
            if (!_propertyMappingService.ValidMappingExistsFor<AuthorDto, Entities.Author>
                ...
                !_propertyCheckerService.TypeHasProperties<AuthorDto>(
            ...
            var result = _mapper.Map<IEnumerable<AuthorDto>>(authorsFromRepo)
                .ShapeData(authorsResourceParameters.Fields);
            
            var shapedAuthorsWithLinks = result.Select(author =>
            {
        ...
        // RequestHeaderMatchesMediaType is used for routing:
        [RequestHeaderMatchesMediaType("Content-Type",
            "application/json",
            "application/vnd.marvin.authorforcreation+json")]
        // used for media type formatter:
